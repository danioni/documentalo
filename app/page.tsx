...
const colorMap: Record<string, { border: string; bg: string; text: string; hoverBorder: string; badgeBg: string; badgeText: string }> = {
  blue: {
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {products.map((product) => {
              ...
              return (
                ...
                >
                  {product.badge && (
                    <span className={`absolute right-4 top-4 rounded-full ${colors.badgeBg} px-2.5 py-0.5 text-xs font-medium ${colors.badgeText}`}>
                      {product.badge}
                    </span>
                  )}
