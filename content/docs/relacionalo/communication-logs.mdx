...
Los registros de comunicación almacenan todas las interacciones enviadas a clientes a través de email (Resend) y WhatsApp (Twilio), permitiendo auditoría y diagnóstico de problemas.
...
| **Enviado** | `sent` | Enviado al proveedor (Resend/Twilio) |
