---
title: "Relacionalo — API de gestión de clientes"
...
Relacionalo es el módulo de gestión de clientes del ecosistema Digitalo. Opera dentro de [Coordinalo](/docs/coordinalo) como uno de los tres módulos principales y gestiona la relación completa con el cliente: desde su primera reserva online hasta las comunicaciones de seguimiento post-sesión.
...
| **Métricas** | Total de sesiones, tasa de asistencia, valor del cliente |
...
```
https://coordinalo.com/explorar/{slug}
```
...
#### Parámetros de consulta (listar clientes)
...
El ciclo de vida completo del cliente en Relacionalo:
...
└─────────┬──────────┘
          ▼
┌────────────────────┐
│  Asiste a sesión   │  ← Estado: confirmado → entregado
└─────────┬──────────┘
          ▼
┌────────────────────┐
...
Relacionalo incluye 11 templates pre-aprobados por Meta, listos para usar. Los templates usan variables dinámicas que se reemplazan automáticamente.
...
Los templates deben ser pre-aprobados por Meta antes de poder usarse en WhatsApp Business. Coordinalo incluye estos 11 templates listos para usar.
...
Relacionalo se integra con los otros dos módulos de Coordinalo:

| Módulo | Relación con Relacionalo |
|--------|--------------------------|
| **[Coordinalo](/docs/coordinalo)** (Operaciones) | Las sesiones agendadas se vinculan al cliente en su ficha |
| **[Planificalo](/docs/planificalo)** (Finanzas) | Las ventas y saldos del cliente se muestran en la ficha |

### Webhooks de gestión de clientes

Relacionalo emite eventos que pueden consumirse vía webhooks:
...
<Cards>
  <Card title="Clientes" href="/docs/relacionalo/clients" description="Gestión completa de clientes y ficha" />
  <Card title="Recordatorios" href="/docs/relacionalo/recordatorios" description="Configuración de mensajes automáticos" />
  <Card title="Logs de comunicación" href="/docs/relacionalo/communication-logs" description="Historial de WhatsApp y email" />
  <Card title="Campañas" href="/docs/relacionalo/campanias" description="Comunicaciones masivas segmentadas" />
  <Card title="Audiencias" href="/docs/relacionalo/audiencias" description="Segmentación de clientes" />
  <Card title="Disputas" href="/docs/relacionalo/disputas" description="Gestión de reclamos y resoluciones" />
</Cards>

---

Relacionalo es parte del ecosistema [Coordinalo](/docs/coordinalo). Ver también: [Planificalo](/docs/planificalo) (Finanzas) · [Servicialo](/docs/servicialo) (Estándar abierto).
