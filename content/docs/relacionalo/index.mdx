---
title: "Relaciónalo — API de gestión de clientes"
...
Relaciónalo es el módulo de gestión de clientes del ecosistema Digitalo. Opera dentro de [Coordinalo](/docs/coordinalo) como uno de los tres módulos principales y gestiona la relación completa con el cliente: desde su primera reserva online hasta las comunicaciones de seguimiento post-sesión.
...
Relaciónalo es parte del ecosistema [Coordinalo](/docs/coordinalo). Ver también: [Planifícalo](/docs/planificalo) (Finanzas) · [Servicialo](/docs/servicialo) (Estándar abierto).
