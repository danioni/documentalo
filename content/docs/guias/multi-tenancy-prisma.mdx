---
title: Multi-tenancy con Prisma y Next.js
description: Cómo implementar una arquitectura multi-tenant usando Prisma ORM
---
...
- [Código fuente de Coordinalo](https://github.com/grupodigitalo/coordinalo) (próximamente)
