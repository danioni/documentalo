...
Planifícalo es el módulo financiero del ecosistema Digitalo. Opera dentro de [Coordinalo](/docs/coordinalo) como uno de los tres módulos principales y gestiona todo el ciclo económico: desde la venta de un paquete de sesiones hasta la liquidación de comisiones al profesional.
...
| **[Relaciónalo](/docs/relacionalo)** (Gestión de clientes) | Los clientes que compran ventas se gestionan desde la ficha de clientes |
...
Planifícalo es parte del ecosistema [Coordinalo](/docs/coordinalo). Ver también: [Relaciónalo](/docs/relacionalo) (Gestión de clientes) · [Servicialo](/docs/servicialo) (Estándar abierto).
