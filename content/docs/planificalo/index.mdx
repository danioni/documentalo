---
title: "Planificalo — API de gestión financiera y liquidaciones"
...
Planificalo es el módulo financiero del ecosistema Digitalo. Opera dentro de [Coordinalo](/docs/coordinalo) como uno de los tres módulos principales y gestiona todo el ciclo económico: desde la venta de un paquete de sesiones hasta la liquidación de comisiones al profesional.
...
#### Parámetros de consulta (listar ventas)
...
#### Parámetros de consulta (listar asignaciones)
...
Planificalo soporta tres modelos de compensación que cubren los esquemas más comunes en organizaciones de servicios:
...
Planificalo se integra con los otros dos módulos de Coordinalo:

| Módulo | Relación con Planificalo |
|--------|--------------------------|
| **[Coordinalo](/docs/coordinalo)** (Operaciones) | Las sesiones completadas disparan la creación de sesiones financieras |
| **[Relacionalo](/docs/relacionalo)** (Gestión de clientes) | Los clientes que compran ventas se gestionan desde la ficha de clientes |

### Webhooks financieros

Planificalo emite eventos que pueden consumirse vía webhooks:
...
<Cards>
  <Card title="Finanzas y Comisiones" href="/docs/planificalo/finances" description="Reparto de ingresos, cálculo automático y reportes" />
  <Card title="Ventas" href="/docs/planificalo/ventas" description="Operaciones completas de ventas con ejemplos" />
...
Planificalo es parte del ecosistema [Coordinalo](/docs/coordinalo). Ver también: [Relacionalo](/docs/relacionalo) (Gestión de clientes) · [Servicialo](/docs/servicialo) (Estándar abierto).
