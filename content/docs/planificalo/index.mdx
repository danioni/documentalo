...
| **[Relaciónalo](/docs/coordinalo/clients)** (CRM) | Los clientes que compran ventas se gestionan desde el CRM |
...
<Cards>
  <Card title="Ventas" href="/docs/coordinalo/ventas" description="CRUD completo de ventas con ejemplos" />
  <Card title="Finanzas y Comisiones" href="/docs/coordinalo/finances" description="Revenue share, cálculo automático y reportes" />
  <Card title="Nóminas" href="/docs/coordinalo/nominas" description="Generación y gestión de nóminas" />
  <Card title="Estados financieros" href="/docs/coordinalo/estados-financieros" description="Reportes consolidados" />
  <Card title="Cobros" href="/docs/coordinalo/cobros" description="Cobros con MercadoPago" />
  <Card title="Pagos a proveedores" href="/docs/coordinalo/pagos-proveedores" description="Liquidación y pagos" />
</Cards>

---

Planifícalo es parte de [Coordinalo](/docs/coordinalo), el módulo de operaciones del ecosistema Digitalo.
