...
description: Estado de resultados, balance y resúmenes financieros en Coordinalo
---

# Estados Financieros

Coordinalo genera reportes financieros automatizados para analizar la salud financiera de la organización, incluyendo estado de resultados (pérdidas y ganancias), balances y resúmenes mensuales.
...
## Estado de resultados por servicio
...
|---------|--------|-------------|
| Estado de Resultados | `pnl` | Pérdidas y ganancias completo con desglose |
